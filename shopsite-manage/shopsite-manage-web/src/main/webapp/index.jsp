...
<!--Header-part-->
<div id="header">
    <h1><a href="dashboard.html">Shopsite Admin</a></h1>
</div>
<!--close-Header-part-->
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> 控制面板</a>
    <ul>
        <li class="active"><a href="index.html"><i class="icon icon-home"></i> <span>控制面板</span></a> </li>
        <li> <a href="charts.html"><i class="icon icon-signal"></i> <span>图表</span></a> </li>
        <li> <a href="widgets.html"><i class="icon icon-inbox"></i> <span>小工具</span></a> </li>
        <li><a href="tables.html"><i class="icon icon-th"></i> <span>表</span></a></li>
        <li><a href="grid.html"><i class="icon icon-fullscreen"></i> <span>全屏宽度</span></a></li>
        <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>表格</span> <span class="label label-important">3</span></a>
            <ul>
                <li><a href="form-common.html">基础形式的表格</a></li>
                <li><a href="form-validation.html">带有验证的表格</a></li>
                <li><a href="form-wizard.html">表单向导和验证</a></li>
            </ul>
        </li>
        ...
        <li class="submenu"> <a href="#"><i class="icon icon-file"></i> <span>插件</span> <span class="label label-important">5</span></a>
            <ul>
                <li><a href="index2.html">控制面板</a></li>
                <li><a href="gallery.html">图片管理</a></li>
